...
<div class="max-w-4xl mx-auto space-y-10">
	...
	<section class="space-y-2">
		...
		<p class="text-muted-foreground">
			Your compliance schedule has been set up.
		</p>
	</section>
	...
	<section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
		<div class="rounded-2xl border p-4">
			...
			<p class="text-2xl font-semibold">{data.totalObligations}</p>
		</div>
	...
	<section class="flex items-center justify-between pt-4">
		<a
			...
			class="inline-flex items-center rounded-xl px-4 py-2 text-sm font-medium bg-primary text-primary-foreground hover:opacity-90"
		>
			Continue setup →
		</a>
